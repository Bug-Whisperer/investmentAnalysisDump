...
| NPM % | **6.7%** | 6.4% | 8.8% | **10.4%** | 8.9% | 8.2% | 10.3% | 10.6% | 9.5% | 8.1% | **10.5%** | 10.2% | 9.0% |
...
| Less: Maintenance CapEx (est 50%) | -266 | -134 | -434 | -457 | -288 | -234 |
| **Owner Earnings** | **581** | **797** | **626** | **667** | **1,212** | **1,304** |
...
**Maintenance CapEx Estimate:** For a paint company, maintenance capex (keeping existing plants running, repainting dealers, maintaining tinting machines) is estimated at approximately 50% of total capex. This gives:

**Owner Earnings (FY25):** ₹1,183 (NP) + ₹354 (D&A) - ₹234 (50% × ₹467 maintenance CapEx) = **₹1,304 Cr** (₹11.17 per share)

SBC is negligible for Berger (Indian promoter-led company with no material ESOP programme), so Base Owner Earnings = true economic earnings. No dilution-adjusted calculation needed.
...
| **Overall** | **6/10** | **Moderate Scaler** |

**Classification: Moderate Scaler** — Berger can grow but requires proportional investment in distribution and capacity. The business has operating leverage in good years but lacks the near-zero marginal cost structure of a truly elite scaler. The increasing competitive intensity means each unit of growth is getting harder to achieve.
...
The Margin of Safety formula used: MoS = (IV − CMP) / IV. All scenarios yield negative MoS, confirming overvaluation.
...
**ROCE vs ROE:** ROCE (24-31%) exceeds ROE (20-27%) in all years — the healthy pattern confirming that the business engine is powerful and the returns to equity holders are genuine.
...
**Traffic Light:** 🟡 YELLOW — **Risky entry.** The 10-year return exceeds the hurdle rate only if P/B stays within 25% of current levels. Any material de-rating (which the intensifying competition makes plausible) would destroy returns. You are dependent on the market sustaining an 8x+ P/B multiple for a decade.
...
| **Value / Buy** | 25-35x | ₹240 – ₹335 | Below base IV; attractive risk-reward |
| **Fair Value / Hold** | 35-45x | ₹335 – ₹425 | Near intrinsic value; hold for compounding |
| **Fully Valued / Trim** | 45-55x | ₹425 – ₹525 | Above IV; limited upside, high de-rating risk |
| **Overvalued / Sell** | > 55x | > ₹525 | Priced for perfection; avoid |

**Current Price ₹450 → Fully Valued / Trim Zone (PE ~50x)**

*(Note: Price ranges are based on normalised EPS of ~₹9.60 from the quarterly run-rate analysis in Section 6, which adjusts for the weak Sep 2025 quarter. Using reported TTM EPS of ₹9.05, the price ranges would be ~5% lower.)*
...
| Value (₹240-335) | ₹240-335 | +34 to +88% profit | **HOLD** — the business quality justifies holding. The stock is no longer cheap but you have a cost advantage. |
| Fair Value (₹335-425) | ₹335-425 | +6 to +34% profit | **HOLD but don't add** — at these prices, adding more capital earns mediocre forward returns. Hold what you have. |
| Fully Valued (₹425-525) | ₹425-525 | -14% to +6% | **DON'T add; consider trimming** — you entered at a premium. Forward returns depend heavily on PE sustaining. With a small capital base, the opportunity cost of holding an overvalued stock is high. |
| Overvalued (>₹525) | > ₹525 | Loss of 14%+ | **Trim or exit** — if you bought at >₹525, the forward expected value is poor. With a small capital base, redeploy into higher-conviction ideas. Purchase price is a sunk cost; forward expected return is what matters. |
...
| **Price significantly below IV?** | **NO — stock is ABOVE intrinsic value in all DCF scenarios.** | ❌ |
...
The paint industry is among the **least regulated** consumer sectors in India. There are no excise-style taxes specific to paints (GST applies uniformly), no licensing requirements, no price controls, and no advertising restrictions (unlike tobacco/alcohol).

**Current Headwinds:**
- **CCI Investigation of Asian Paints:** The Competition Commission of India is investigating Asian Paints for alleged abuse of dominant position (pressuring dealers into exclusivity). If penalties result, this could BENEFIT Berger by levelling the competitive playing field.
- **VOC Regulations:** BIS and CPCB are enforcing stricter volatile organic compound limits, pushing the industry toward water-borne coatings. This benefits organised players like Berger (who already have water-borne technology) and hurts smaller unorganised players — effectively strengthening the moat.
- **Crude Oil / Input Costs:** The most significant "regulatory" headwind is actually macroeconomic — crude oil prices (which drive TiO₂ and petrochemical costs) are the single biggest margin variable. The April 2026 crude spike to ~$120/bbl prompted 5-10% price hikes industry-wide.

**Buffett's Verdict:** **(a) Manageable and potentially beneficial.** Regulatory risk is minimal. The VOC regulations actually strengthen the moat by raising barriers to entry for unorganised players. The crude oil risk is cyclical and manageable — Berger has survived multiple crude cycles and recovered margins within 2-3 quarters.
...
| Valuation | 3/10 | PE ~50x, P/B ~8.5x — extremely expensive by any absolute measure |
