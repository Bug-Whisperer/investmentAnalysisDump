...
*Note: All BVPS figures adjusted to post-bonus share base of ~15.6 Cr shares.*
...
**Starting Point:** FY25 Owner Earnings = ₹1,159 Cr (₹74.3/share)
**Discount Rate:** 10% (Buffett's hurdle rate)
**Net Cash Position:** ₹3,018 Cr (adds to equity value)
...
| PV of 10Y Cash Flows (₹ Cr) | 12,123 | 13,872 | 15,881 |
| PV of Terminal Value (₹ Cr) | 20,056 | 27,502 | 37,833 |
| Enterprise Value (₹ Cr) | 32,179 | 41,374 | 53,714 |
| Plus: Net Cash (₹ Cr) | 3,018 | 3,018 | 3,018 |
| **Equity Value (₹ Cr)** | **35,197** | **44,392** | **56,732** |
| **IV Per Share (₹)** | **₹2,256** | **₹2,846** | **₹3,637** |
| **Margin of Safety (IV−CMP)/IV** | **5.1%** | **24.8%** | **41.1%** |
| **Upside/(Downside) from CMP** | **+5.4%** | **+32.9%** | **+69.9%** |

### Summary:

| Scenario | IV/Share | MoS | Upside |
|---|---|---|---|
| Conservative | ₹2,256 | 5.1% | +5.4% |
| **Base** | **₹2,846** | **24.8%** | **+32.9%** |
| Optimistic | ₹3,637 | 41.1% | +69.9% |

At the current price of ₹2,141, GPIL offers a **24.8% margin of safety** under the Base scenario and positive upside under all three scenarios. Even the Conservative scenario suggests the stock is approximately fairly valued. The Base and Optimistic scenarios indicate meaningful undervaluation.

The massive net cash position (₹3,018 Cr, or ~₹194/share) provides a substantial margin of safety floor — it represents ~9% of market cap as liquid financial assets.

Buffett: *"Price is what you pay, value is what you get."* At ₹2,141, you're paying for roughly the Conservative scenario and getting the Base-to-Optimistic scenario for free if the business continues executing.
...
| Normalised Bear Case | Conservative DCF | ₹2,256 | +5.4% (actually upside) |
...
|---|---|---|---|
| Base Case | Base DCF IV ₹2,846 | ₹2,846 | +33% |
| Bull Case | Optimistic DCF IV ₹3,637 | ₹3,637 | +70% |
...
Base Case Upside: ~33% (to ₹2,846)
Asymmetry Ratio: 33% / 23% = 1.4:1
```

With the Bull Case upside of 70%, the ratio improves to **3.0:1** — a decent fat pitch.
...
> *"At ₹2,141, the realistic downside is approximately 23% to ₹1,646 (Tails scenario). The realistic base-case upside is approximately 33% to ₹2,846 over 3-5 years (Heads scenario), with bull-case upside of 70% to ₹3,637. This gives an asymmetry ratio of 1.4:1 (base) to 3.0:1 (bull). The catalysts include F&O addition, excise stabilisation, and continued DII accumulation. This IS a moderate fat pitch — not a table-pounding one, but a favourable risk-reward at a reasonable price."*

**Mispricing Identification:**

The mispricing opportunity is **PRESENT but MODERATE.** The market is partially mispricing GPIL due to: (a) ESG-driven FII selling creating artificial price depression; (b) excise duty transition uncertainty causing near-term earnings noise; (c) the 45% correction from highs creating a recency bias of "the stock was too expensive, so it must still be." If the market corrects this over 2-3 years as excise clarity emerges and DII buying continues, the stock re-rates from the current 26x to its fair value range of 28-30x, generating 15-25% returns BEFORE any underlying EPS growth.
...
|---|---|---|---|---|
| **6.4x (stays)** | Multiple sustains | **10.9%** | **10.9%** | **10.9%** |
| 4.8x (75% of current) | Mild de-rating | 4.7% | 6.4% | 7.7% |
| 4.0x | Moderate de-rating | 0.9% | 3.7% | 5.8% |
| 3.2x (50% of current) | Significant de-rating | -3.5% | 0.4% | 3.4% |
| 3.0x | Severe de-rating | -4.7% | -0.5% | 2.8% |
| 1.0x Book | Valued at book (worst case) | -23.5% | -15.0% | -7.9% |
...
| Price significantly below IV? | ~25% margin of safety (Base DCF); fair value zone currently | ⚠️ |
...
| **Margin of Safety** | **6/10** | ~25% MoS on Base DCF; moderate but not generous for a concentrated bet |
...
At the current price of ₹2,141 (26x TTM PE), the stock sits in the **Fair Value zone.** It is not cheap enough for a concentrated "swing hard" bet (which would require <20x PE or ~₹1,650), but it is reasonable enough for a starter position with the intention to accumulate aggressively on any correction into the ₹1,650-1,975 Value zone.
