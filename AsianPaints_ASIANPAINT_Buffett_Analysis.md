# Asian Paints Ltd (ASIANPAINT) — Warren Buffett-Style Investment Analysis

**Analysis Date:** April 24, 2026  
**Current Market Price (CMP):** ₹2,500 (approx.)  
**Market Capitalisation:** ₹2,40,000 Cr  
...
Asian Paints is India's largest and the world's eighth-largest decorative coatings company, founded in 1942. The business model is elegantly simple: the company manufactures decorative and industrial paints, distributes them through an unrivalled network of 80,000+ dealer touchpoints, and earns high returns by combining brand dominance with supply-chain efficiency.

**Business Model Type: Consumer Franchise + Distribution Moat**

The decorative paints business is a classic Buffett "consumer franchise" — the product is consumed repeatedly (repainting every 3-5 years), the brand influences purchase decisions (homeowners and painters trust Asian Paints), and switching costs exist through the tinting ecosystem (Asian Paints colour machines at dealer shops lock in the retailer). The company has expanded into adjacent home décor categories — waterproofing, adhesives, bath fittings (Sleek kitchens, White Teak), sanitaryware, and uPVC windows — transforming itself into an integrated "home improvement" platform.
...
### Annual Income Statement (₹ Crores, Consolidated)
...
### Growth Summary (CAGRs)

| Period | Revenue CAGR | Net Profit CAGR | EPS CAGR |
|---|---|---|---|
| 10Y (FY15-FY25) | 9.6% | 10.0% | 10.1% |
| 5Y (FY20-FY25) | 10.9% | 6.0% | 6.3% |
| 3Y (FY22-FY25) | 5.2% | 6.3% | 6.6% |
...
The only moderate concern is the rising capital work in progress (CWIP) from ₹1,020 Cr in FY23 to ₹2,698 Cr in FY24 (now back to ₹1,254 Cr in FY25), indicating significant ongoing capex — likely the new manufacturing facilities being built to expand capacity.

---

## 4. CASH FLOW ANALYSIS — The Lifeblood of Valuation

### Cash Flow Summary (₹ Crores, Consolidated)
...
Cash flow generation is strong but lumpy. The FY18-FY19 dip was due to the Ind-AS 116 transition and heavy capex (new plant capacity). FY22 was weak due to massive working capital build-up from raw material cost inflation. The standout years are FY21 (₹3,683 Cr CFO — COVID-era working capital release) and FY24 (₹6,104 Cr — excellent cash conversion).

Operating cash flow conversion from net income has averaged ~98% over the cycle — outstanding. Free cash flow conversion from net income has averaged ~52%, dragged lower by lumpy capex years (FY18, FY19, FY22, FY24); excluding those heavy-capex years, FCF conversion averages ~70%, which is healthy for a manufacturing business. Asian Paints has no SBC programme and no share buyback programme — the share count has remained rock-steady at 96 Cr for the entire analysis period. This is a major positive: zero dilution. Dividends are the primary capital return mechanism, with payout rising from ~42% to 65% over the decade — management is returning more cash as growth moderates.

Buffett: *"Accounting is the language of business."* The cash flow statement corroborates the income statement story — this is a business that reliably converts earnings into cash. The occasional lumpy capex years (FY18-FY19 for new plant, FY24 for expansion) are growth investments, not maintenance spending gone wrong.
...
> **Bolding convention:** Best and worst years are bolded for each ratio. Where multiple years tie at the extreme value (e.g., Inventory Days: FY17, FY22, and FY25 all tie at 142; Inventory Days: FY14 and FY16 tie at 108; Debtor Days: FY14 and FY16 tie at 30), the chronologically first occurrence is bolded to avoid visual clutter.

### Part B: Buffett's Quality Checklist

| Criterion | Benchmark | Company Score | Verdict |
|---|---|---|---|
| ROE > 15% consistently | >15% | 27.1% (10Y avg); range 19.5-32.5% | ✅ Excellent — never below 19% even in worst year |
| ROCE > 15% | >15% | 34.3% (10Y avg); 10Y range 26-42% (45% in FY14) | ✅ Outstanding |
| Debt/Equity < 0.5 | <0.5 | 0.12 (FY25); never above 0.14 | ✅ Virtually debt-free |
| Consistent profit growth | Growing | 10.0% CAGR 10Y; but FY25 -33% | ⚠️ Long-term good, but FY25 is a sharp break |
| Sales growth | Growing | 9.6% CAGR 10Y; FY25 -4.5% | ⚠️ Decelerating; recent YoY decline |
...
The ratio trends reveal a business with a wide, durable moat (consistently high ROCE of 26-45% over 12 years — this is pricing power and capital efficiency at its finest) but one that is facing cyclical margin pressure. The rising cash conversion cycle (52 → 107 days over the decade) and rising working capital days (5 → 52) are mild concerns — they suggest the business is becoming less capital-efficient as it grows, possibly due to the expanding home décor segment which carries different working capital dynamics than core paints.

---

## 6. QUARTERLY TREND ANALYSIS — Recent Momentum

### Quarterly P&L (₹ Crores, Consolidated)
...
*"In the business world, the rearview mirror is always clearer than the windshield."* — Warren Buffett. The rearview mirror shows FY24 was the peak; the windshield is cloudy with competitive intensity.
...
**Promoter Holding:** Rock-solid at 52.63% for years — no reduction, no pledging. The Choksi-Dani families that founded Asian Paints have maintained their stake without a single share sold. This is the strongest possible signal of insider conviction. Promoter shares are worth approximately ₹1,26,000 Cr — massive skin in the game.

**FII Exodus — The Biggest Signal:** FIIs have reduced from 17.65% (Sep23) to 11.64% (Sep25) — a massive exit of approximately 6.0 percentage points of the company, worth roughly ₹14,400 Cr at current market cap. The slight uptick to 12.78% in Dec25 suggests the FII selling may be bottoming out.

**DII Accumulation — The Contrarian Signal:** DIIs have more than doubled their holding from 9.96% to 21.08% in three years. This is domestic mutual funds, insurance companies, and pension funds buying aggressively into the FII selling. The DII accumulation has been particularly dramatic in the Jun25 quarter (jumping from 15.51% to 20.98% in a single quarter).

**Public/Retail Decline — The Retail Signal:** Public/retail holding has fallen from 20.32% (Mar23) to 13.37% (Dec25) — a ~7pp exit over three years, alongside a falling shareholder count (12.14 lakh in Mar25 → 10.01 lakh in Dec25). The proximate cause is the mathematical redistribution as DIIs scaled up: when DIIs jumped from ~15% to ~21% in a single quarter (Jun25), some of that came from public/retail consolidating into the institutional bucket via mutual fund flows. The signal is mixed — domestic flows are migrating from direct retail into managed institutional vehicles (a structural India SIP-era phenomenon), rather than retail dumping the stock. The declining shareholder count is the more concerning sub-signal, suggesting some genuine retail disillusionment with the post-FY24 underperformance.

**Contrarian Signal Check:** Classic contrarian setup — FIIs selling into DII buying. The FII exit likely reflects global portfolio rebalancing (overweight India reduction), valuation concerns (PE compression from 80x+ to 60x), and fundamental deterioration (FY25 earnings decline). The DII accumulation suggests domestic smart money sees the competitive threat as temporary and the franchise value as intact.

*"Be fearful when others are greedy, and greedy when others are fearful."* — Warren Buffett. FIIs are clearly fearful of Asian Paints right now. The question is whether their fear is justified (structural competitive erosion) or overdone (cyclical margin pressure that will pass).
...
Owner Earnings for FY25: ₹3,710 + ₹1,026 − ₹1,076 = ₹3,660 Cr (₹38.12/share).

TTM Owner Earnings (last 4 quarters): approximately ₹4,054 Cr (₹42.23/share).

> **Note on share count basis:** Per-share figures throughout this analysis use **96 Cr shares** (consistent with the FY25 share capital of ₹95.92 Cr at ₹1 face value as disclosed in the annual report). The Screener-reported TTM EPS of ₹40.10 implies a weighted-average diluted share count of ~97.5 Cr (3,910 / 40.10), reflecting the impact of treasury-share / ESOP-trust adjustments in Screener's calculation. This is a ~1.5% difference that has no material effect on per-share OE or any investment conclusion — using 97.5 Cr would lower OE/share to ~₹41.6 instead of ₹42.23.

The capex pattern is clearly lumpy — Asian Paints builds new manufacturing capacity in bursts (FY18-FY19 was the last major capacity expansion cycle, FY24 was another with ₹3,908 Cr). In between, capex drops to 2-5% of revenue. The normalised maintenance capex for a paint company is modest — plants have long useful lives and the manufacturing process is not capital-intensive once built. **The 65% maintenance assumption is used as a deliberate conservative upper bound for this analysis** — Asian Paints does not disclose a maintenance-vs-growth capex split in its annual reports, but normalised maintenance is more likely 50-60% of total based on the lumpy growth-capex cycles visible in the data. Using 65% deliberately understates Owner Earnings (and therefore Intrinsic Value) by ~4-5%, ensuring the overvaluation finding errs on the side of caution. A 55% assumption would raise Base IV to roughly ₹1,260 (still well below CMP ₹2,500); none of the investment conclusions change.

Asian Paints has zero SBC and zero share dilution — the entire SBC & Dilution analysis section is not applicable. This is a major positive. EPS and BVPS growth are purely organic, not inflated by accounting gimmicks or obscured by dilution.

Buffett: *"The first test of earnings quality is whether they are reported honestly. The second test is whether they can be converted to cash."* Asian Paints passes both tests emphatically — no SBC to adjust for, reliable FCF conversion, and zero dilution.

---

## 9. RETURN ON CAPITAL — The Buffett Quality Test

### Return on Capital Table
...
> **Note on rounding:** The "DuPont ROE" column is computed from full-precision (unrounded) inputs and may differ by 0.1pp from a direct arithmetic of the displayed (rounded) row inputs. For example, FY16's stated DuPont ROE of 31.9% reflects the unrounded NPM × AT × EM product; multiplying the displayed rounded values (12.6% × 1.466 × 1.730) yields 32.0%, a 0.1pp rounding artefact. The Reported ROE column is from the audited financials.
...
Buffett: *"Time is the friend of the wonderful business, the enemy of the mediocre."* A business earning 25%+ ROE over a decade with virtually zero leverage is definitionally wonderful. Time has been — and should continue to be — Asian Paints' ally. The FY25 dip, unless it persists, doesn't change the structural quality.

---

## 10. COMPETITIVE POSITION & MOAT ANALYSIS

### Moat Type: **Brand + Distribution + Switching Costs (Tinting System)**
...
**3. Tinting System Lock-In:** Asian Paints deploys colour-mixing (tinting) machines at dealer shops. Once a dealer invests space and training in the Asian Paints tinting system, switching to a competitor requires replacing the machine, retraining staff, and disrupting customer relationships. This creates meaningful switching costs at the retail level.

**4. Supply Chain & Cost Efficiency:** 27 manufacturing plants globally (India: 17 per Section 13 Operating Metrics; international: ~10 across 15+ countries — Middle East, South Asia, Africa) with India's most sophisticated paint supply chain — raw material procurement scale, logistics optimisation, and demand forecasting algorithms give Asian Paints a structural cost advantage of 2-3% of revenue over smaller competitors.

### Competitive Threats — The New Reality

**Birla Opus (Grasim/Aditya Birla Group):** This is the most significant competitive threat Asian Paints has faced in decades. Grasim has committed ₹10,000+ Cr to build paint manufacturing capacity and is pricing aggressively (10-15% below Asian Paints on comparable products) with a massive advertising blitz. Birla Opus has already gained ~3-4% market share within 18 months of launch. This is NOT a fringe threat — the Aditya Birla Group has the financial muscle, distribution network (via UltraTech Cement dealers), and brand credibility to sustain a multi-year competitive assault.

**JSW Paints:** Another well-funded new entrant, though smaller in scale than Birla Opus. JSW has been in the market since 2019 but remains sub-scale.

**Berger Paints:** The established #2 player (market share ~18-20%) continues to compete effectively, particularly in eastern India.

**Technological Disruption Risk:** Assessed as **negligible**. Decorative paint is a low-tech, tactile consumer product applied by trained painters using brushes, rollers, and spray equipment. There is no meaningful exposure to AI, software, or fintech disruption. The tinting machines at dealer shops are essentially mechanical-electronic colour mixers, not platforms that AI can disintermediate. Direct-to-consumer e-commerce in paints is structurally limited because paint requires colour-matching consultation, painter coordination, and same-day local availability — all of which favour the existing dealer-painter ecosystem. (Cross-reference: Section 19 Buffett Checklist also rates this dimension as "Pass — Resistant to Disruption.")

### Is the Moat Enduring or Eroding?

The honest assessment: the moat is **wide but narrowing at the edges.** Asian Paints' core competitive advantages (brand, distribution depth in small towns, tinting lock-in) remain intact. But Birla Opus's entry is the first time in 30 years that a well-funded, well-managed competitor has directly attacked Asian Paints' market share with aggressive pricing and distribution build-out. The FY25 margin compression and revenue decline are partially attributable to Asian Paints' defensive response — matching competitor pricing rather than ceding market share.

### Is the Business Susceptible to Change?

Buffett said: *"We do not get enthused about change, with a few exceptions, as a way to make a lot of money. We're looking for the absence of change to protect ways that are already making a lot of money."*

The decorative paints business in India has been remarkably resistant to change for decades — people paint their homes the same way they did 30 years ago, brand preferences are sticky, and the dealer-painter-homeowner ecosystem evolves slowly. This absence of change has been Asian Paints' greatest friend. However, two vectors of change are emerging: the entry of well-funded competitors (Birla Opus), and the rise of waterproofing/textured finishes/home décor as adjacent categories. The first is a genuine threat; the second is an opportunity that Asian Paints is well-positioned to capture.

**Verdict:** The moat is still wide — but it's facing the most serious competitive assault in its history. Monitor Birla Opus's market share trajectory closely over the next 2-3 years. If Asian Paints' volume market share stabilises above 50%, the moat has held. If it drops below 45%, the moat is eroding.
...
| Metric | FY15 | FY17 | FY19 | FY21 | FY23 | FY25 | Trend |
|---|---|---|---|---|---|---|---|
...
### Scaling Quality Classification

| Score Range | Classification | Buffett Analogy | Asian Paints Assessment |
|---|---|---|---|
| 9-10 | Elite Scaler | Coca-Cola (1988), Apple (2016) — near-infinite runway, near-zero marginal cost, moat widens with scale | — |
| 7-8 | Strong Scaler | GEICO, American Express — proven model, clear runway, good unit economics | — |
| **5-6** | **Moderate / Friction Scaler** | Kraft Heinz / IBM — can grow but requires proportional capital; rising friction | **✓ Asian Paints (6.6/10) — proven model, clear TAM runway, but declining Asset Turnover (1.60x→1.13x) and incremental ROIC compression to 13.7% signal rising capital intensity; competitive friction from Birla Opus** |
| 3-4 | Scaling Friction | IBM late stage — growth requires enormous investment, diminishing returns | — |
| 1-2 | Anti-Scaler / Saturated | Newspapers, landline telecom — market shrinking, scale provides no advantage | — |
...
Over the FY14-FY25 period:

| Metric | Value |
|---|---|
| Total Net Profit (FY14-FY25) | ₹33,344 Cr |
| Total Dividends Paid | ₹17,786 Cr |
| **Total Retained Earnings** | **₹15,558 Cr** |
| External Capital Raised | ₹0 (zero equity dilution) |
| Market Cap (FY14 start, approx.) | ₹50,880 Cr |
| Market Cap (FY25 end, approx.) | ₹2,33,280 Cr |
| **Market Cap Change** | **₹1,82,400 Cr** |
| **$1 Test Result** | **₹11.72 of market value created per ₹1 of retained earnings** |

> **Note on $1 Test market cap basis:** The endpoint market cap (₹2,33,280 Cr, implying ~₹2,430/share) corresponds to the FY25 year-end (March 31, 2025), not the April 24, 2026 analysis-date CMP of ₹2,500 (₹2,40,000 Cr). FY25-end is used to maintain temporal consistency with the cumulative NP and dividend figures, which are also computed through FY25 (year ending March 31, 2025). Using the analysis-date market cap would yield ₹12.15 — directionally identical and immaterial to the conclusion.

This is an extraordinary result. For every rupee of earnings retained by management (not paid as dividends), they created ₹11.72 of market value. This is among the best $1 test results of any Indian company. For context, the threshold is ₹1.00 — anything above that means management is creating value with retained capital. ₹11.72 is exceptional.

However, a caveat: a large portion of this market value creation came from PE multiple expansion (the stock went from ~41x PE to ~63x PE), not just from earnings growth. If we strip out the PE expansion and look at pure earnings compounding, the story is still excellent — EPS grew from ₹14.54 to ₹38.23 (10.1% CAGR), meaning retained earnings were reinvested at approximately 25% ROE consistently.

### Management Assessment

**Capital Allocation:** Excellent. Management has never done a dilutive equity raise, never made a large value-destroying acquisition, and has steadily increased dividends. The expansion into home décor (kitchens, bath fittings) is still unproven and has been a drag on margins (White Teak impairment in Q3 FY26), but the capital deployed is small relative to the core business.

**Candour:** Asian Paints management is among the most transparent in Indian corporate history. Concalls are detailed, honest about challenges, and provide granular volume/margin data. CEO Amit Syngle has been candid about competitive pressures and margin headwinds.

**Insider Ownership:** 52.63% promoter holding — massive skin in the game worth ~₹1,26,000 Cr.

**SBC:** Zero. No stock options, no ESOPs diluting shareholders. This is increasingly rare and is a significant positive.

**Recent Management Changes & Succession:** **Amit Syngle** has been Managing Director & CEO since April 1, 2020, having joined Asian Paints in 1990 — 35+ years of company tenure before assuming the top job. His extended tenure as COO and head of decorative paints prior to becoming CEO gives him deep institutional knowledge of the dealer ecosystem, supply chain, and the painter-loyalty programme. The Choksi-Dani promoter families remain actively engaged through the board; **Manish Choksi** continues as Vice-Chairman. The board includes seasoned independent directors and the senior management bench (Group CFO R J Jeyamurugan; Chief of Decorative Business; Chief of International Business) is stable with multi-decade Asian Paints tenures — a deliberately groomed succession pipeline. No abrupt leadership transitions, no CFO/auditor changes, and no governance flags in the recent period. The principal succession risk is concentrated in Syngle himself given the post-COVID competitive intensity coinciding with his tenure; however, the management depth and the lack of any single-point-of-failure dependency mitigate this risk to a low-probability event.

Buffett: *"When management with a reputation for brilliance tackles a business with a reputation for bad economics, it is the reputation of the business that remains intact."* The reverse is also true — when excellent management runs a business with wonderful economics, both reputations are enhanced. Asian Paints is this case.
...
|---|---|---|---|---|---|---|---|
| Domestic Decorative Revenue (₹ Cr, approx.) | ~17,000 | ~18,500 | ~25,000 | ~29,500 | ~30,500 | ~28,500 | ↓ in FY25 |
| Volume Growth (domestic decorative) | ~2% | ~7% | ~25% | ~8% | ~4% | ~2% | Decelerating |
| International Revenue (₹ Cr) | ~2,800 | ~2,500 | ~3,300 | ~3,800 | ~3,500 | ~3,400 | Flat |
| Organised Market Share (est.) | ~55% | ~55% | ~54% | ~54% | ~53% | ~51-52% | ↓ Slight erosion |
| Dealer Network Size | ~70,000 | ~72,000 | ~75,000 | ~78,000 | ~80,000 | ~82,000+ | ↑ Expanding |
| Manufacturing Plants (India) | 15 | 15 | 15 | 15 | 16 | 17 | ↑ New capacity |
| Debtor Days | 32 | 44 | 49 | 49 | 50 | 46 | Worsened then improving |
| Inventory Days | 127 | 134 | 142 | 121 | 122 | 142 | Volatile |

The slight market share erosion from ~55% to ~51-52% over 5 years is the most concerning operational metric. While 2-3pp loss sounds small, in a ₹55,000+ Cr market, each percentage point represents ~₹550 Cr of revenue. The share loss is being driven primarily by Birla Opus's entry and aggressive pricing. Asian Paints has responded with its own competitive actions (promotional pricing, enhanced dealer margins, accelerated tinting machine deployments) which have protected volumes but compressed margins.
...
| Earnings Yield | 1.60% | Below 10Y G-Sec yield (~7%) |
...
Asian Paints has historically traded at premium valuations — the stock has rarely dipped below 40x PE in the last decade. The current 62x PE is above the 10-year median of ~55x but below the peak of 80x+ reached in late FY22/early FY23. The stock has NEVER traded sustainably at PE multiples below 35x in the last decade, which tells you this is a permanently expensive stock relative to the market. The question is not "Is it cheap?" (it never is) but rather "Is the premium justified and sustainable?"

At 12.4x P/B, the market is valuing Asian Paints at a massive premium to book value. This is justified ONLY if ROE remains well above the cost of equity (which it does at 20-30% ROE). However, if ROE normalises down to 18-20% (as FY25 suggests), the justified P/B drops significantly.
...
**Starting Point:** TTM Owner Earnings = ₹4,054 Cr (₹42.23/share)  
**Discount Rate:** 10% (Buffett's hurdle rate)  
**Net Cash:** ₹2,435 Cr (added to equity value)  
**Shares Outstanding:** 96 Cr (diluted = basic; no dilution)

| Scenario | Growth Y1-5 | Growth Y6-10 | Terminal Growth | IV/Share | MoS at ₹2,500 | Upside/(Downside) |
|---|---|---|---|---|---|---|
| **Stress** | 2% | 5% | 3.5% | **₹686** | -264% (overvalued) | -72.6% |
...
**The DCF is unambiguous: at ₹2,500, Asian Paints is significantly overvalued by every traditional DCF measure.** Even under the optimistic scenario (15% owner earnings growth for 5 years, 10% for the next 5), intrinsic value is only ₹1,638 — implying a 34.5% downside from CMP to IV (or equivalently, 53% above IV). Under the base case, the stock would need to fall 52% to reach intrinsic value (109% above IV). The two conventions describe the same gap from different reference points; both are presented above (Upside/Downside column uses CMP basis; MoS column uses IV basis).

This result is consistent with the company's 1.6% earnings yield. When earnings yield is 1.6% and Buffett's hurdle rate is 10%, the math simply doesn't work unless you believe in sustained 20%+ earnings growth for a decade — which is higher than Asian Paints has EVER delivered on a sustained basis.

**Why does the market price Asian Paints so far above DCF value?** The market assigns a "quality premium" to Asian Paints' extraordinary competitive position, pricing the stock as a quasi-bond with growth optionality. Investors accept 1-2% earnings yield because they believe the earnings stream is nearly as reliable as a government bond but with 10-12% growth. This logic has held for a decade but breaks down if growth decelerates to <10% (as it has in FY25) or if competition permanently impairs margins.

Buffett: *"Price is what you pay, value is what you get."* At ₹2,500, you are paying a steep price for a wonderful business. Whether you "get" value depends entirely on whether growth re-accelerates to 12-15%.
...
> **Time-base disclosure (Issue addressed):** The Historical 5Y OEPS CAGR of 2.5% uses **FY25 annual OE per share (₹38.12 = ₹3,660 Cr / 96 Cr shares)** as the endpoint vs **FY20 OEPS (₹33.74)** as the start. The DCF and "Current OEPS" elsewhere use the more recent **TTM OE per share (₹42.23 = ₹4,054 Cr / 96 Cr shares)** as the base, which includes two post-FY25-trough recovery quarters (Sep25, Dec25). Using TTM OEPS as the endpoint of the 5Y CAGR (vs FY20's ₹33.74) would yield ~4.6% — still below the 10Y average of 10.3%. Both figures are presented transparently; the 2.5% figure uses fully-audited annual data for the comparison.
...
|---|---|---|---|
| 5 Years | 46.2% | 52.9% | 59.5% |
| 10 Years | 26.8% | 32.6% | 38.4% |
| 15 Years | 21.0% | 26.5% | 31.9% |

**At Terminal PE = 20x (Market Average)**

| Period | 10% Return | 15% Return | 20% Return |
|---|---|---|---|
| 5 Years | 38.1% | 44.3% | 50.6% |
| 10 Years | 23.2% | 28.8% | 34.4% |
| 15 Years | 18.7% | 24.0% | 29.4% |

**At Terminal PE = 28x (Above-Average Compounder)**

| Period | 10% Return | 15% Return | 20% Return |
|---|---|---|---|
| 5 Years | 29.1% | 34.9% | 40.8% |
| 10 Years | 19.2% | 24.6% | 30.0% |
| 15 Years | 16.0% | 21.3% | 26.6% |

**At Terminal PE = 55x (Historical Average)**

| Period | 10% Return | 15% Return | 20% Return |
|---|---|---|---|
| 5 Years | 12.8% | 17.9% | 23.0% |
...
**At terminal PE of 28x (mild PE compression):** To earn 10% return over 10 years, Asian Paints needs 19.2% EPS CAGR — nearly 2x the historical 10Y CAGR. **🟠 ORANGE** — expensive.
...
**OEPS Traffic Light (explicit verdicts):**
- At terminal **P/OE 17x / 10Y / 10% hurdle**, OEPS needs **24.6% CAGR** vs historical 10.3%. **🔴 RED** — implied growth more than 2x historical.
- At terminal **P/OE 17x / 10Y / 15% hurdle**, OEPS needs **30.3% CAGR**. **🔴 RED** — implausible.
- At terminal **P/OE 55x (historical premium) / 10Y / 10% hurdle**, OEPS needs **~11-12% CAGR** (proxied via the 1.4pp divergence above the EPS 11.4%). **🟡 YELLOW** — in line with historical, but requires the 55x PE premium to persist for a decade.

EPS and OEPS verdicts converge in every scenario (1.4pp divergence is below the 2pp threshold for capital-intensity concern). Defer to the OEPS verdict as the primary Buffett-pure assessment — both yield the same answer here.
...
| Scenario | Basis | Implied Price | Upside from ₹2,500 |
|---|---|---|---|
| Base DCF | ₹1,198 IV | ₹1,198 | -52.1% (negative!) |
| Optimistic DCF | ₹1,638 IV | ₹1,638 | -34.5% (negative!) |
| PE sustains at 60x + 12% EPS growth (5Y) | 60 × ₹70.8 | ₹4,248 | +69.9% |
| PE re-rates to 70x + 15% growth (5Y) | 70 × ₹80.7 | ₹5,647 | +126.0% |

**Part 3: Asymmetry Ratio**

Using the "Historical Low PE Floor" (₹1,400, -44% downside) and the "PE sustains + 12% growth" upside (₹4,248, +70% upside):

Asymmetry Ratio = 70% / 44% = **1.6:1**
...
| Year | Net Profit Margin | Asset Turnover | Equity Multiplier | DuPont ROE | Reported ROE |
|---|---|---|---|---|---|
| FY14 | 10.3% | 1.513 | 2.00 | 31.2% | 31.3% |
| FY16 | 12.6% | 1.466 | 1.73 | 31.9% | 32.0% |
| FY18 | 12.5% | 1.286 | 1.63 | 26.3% | 26.2% |
| FY20 | 13.7% | 1.248 | 1.65 | 28.2% | 28.3% |
| FY22 | 10.6% | 1.344 | 1.63 | 23.2% | 23.2% |
| FY24 | 15.7% | 1.275 | 1.60 | 32.1% | 32.0% |
...
The FY25 ROE decline from 32.0% to 19.5% is entirely margin-driven — NPM dropped from 15.7% to 10.9%. Asset turnover also declined (1.275 → 1.125) due to revenue shrinkage while the asset base grew. Leverage was essentially flat. So the ROE decline is a profitability problem, not a leverage problem — which means it's fixable through margin recovery.

**ROCE vs. ROE:** ROCE (26%) > ROE (19.5%) in FY25, confirming that the business engine generates strong pre-tax, pre-interest returns and that leverage is NOT propping up ROE. This is the healthy pattern.
...
| CMP | ₹2,500 |
| Current P/B | 12.37x |
| Sustainable ROE | 22% (normalised, not peak) |
| Retention Ratio | 35% (65% payout) |
| BV Compounding Rate | 7.7% (22% × 35%) |
...
**Expected Return CAGR at CMP ₹2,500 (Entry P/B: 12.4x)**
...
### DCF-Based Price Zones

| Zone | Price Range | PE Range (on ₹40 EPS) | P/B Range | Rationale |
|---|---|---|---|---|
| **Deep Value / Strong Buy** | < ₹645 | <16x | <3.2x | 30%+ MoS to Conservative IV; once-in-a-decade opportunity |
| **Value / Buy** | ₹645 – ₹922 | 16-23x | 3.2-4.6x | Below Conservative IV; meaningful margin of safety |
| **Fair Value / Hold** | ₹922 – ₹1,198 | 23-30x | 4.6-5.9x | Between Conservative & Base IV; fair price for quality |
| **Fully Valued / Trim** | ₹1,198 – ₹1,638 | 30-41x | 5.9-8.1x | Between Base & Optimistic IV; limited upside |
| **Overvalued / Sell** | > ₹1,638 | >41x | >8.1x | Above Optimistic IV; priced for perfection |
...
|---|---|---|---|
| Deep Value (< ₹645) | ₹400-645 | +287% to +525% | **HOLD & enjoy the compounding.** You bought at Buffett prices. The business quality justifies holding despite elevated market PE. Your cost basis is so low that even severe PE compression won't take you to a loss. "Our favourite holding period is forever" applies here. |
| Value (₹645-922) | ₹645-922 | +171% to +287% | **HOLD.** You bought at a reasonable price. The returns have been excellent. Continue holding as long as the moat is intact. Don't sell a wonderful business just because the market is overvaluing it — unless you have a better opportunity. |
| Fair Value (₹922-1,198) | ₹922-1,198 | +109% to +171% | **HOLD but don't add.** Your entry was fair but not a bargain. The profit buffer exists. Continue holding for long-term compounding but don't increase your position at current prices. |
| Fully Valued (₹1,198-1,638) | ₹1,198-1,638 | +53% to +109% | **HOLD cautiously.** Your entry was expensive and the profit buffer is thinner. If fundamentals deteriorate further (Birla Opus gains significant share, margins don't recover), consider trimming. |
| Overvalued (₹1,638-2,500) | ₹1,638-2,500 | 0% to +53% | **Consider trimming.** You bought at a premium to all DCF valuations. With a small capital base, deployed in the overvalued zone at the margin, the opportunity cost is significant. The capital may work harder elsewhere. Buffett: "Purchase price is a sunk cost. What matters is forward expected value." |
| Bought at current prices (~₹2,500) | ~₹2,500 | Breakeven | **Don't add. Monitor.** Forward returns from ₹2,500 are likely to be sub-10% unless growth materially reaccelerates. "The price you pay determines your return." With a small capital base, every allocation must work hard — a 7-8% return from Asian Paints may not be optimal. |
...
|---|---|---|
| **Circle of Competence** | Paint is a simple, understandable consumer product. The economics are transparent. | ✅ Pass |
| **Enduring Moat** | Brand, distribution, tinting system. Moat is wide but facing first serious competitive threat in decades (Birla Opus). | ⚠️ Conditional Pass |
| **Trustworthy Management** | Excellent capital allocation, zero dilution, 52.63% promoter holding, candid communications. | ✅ Pass |
| **Resistant to Disruption** | Decorative paint is low-tech, tactile, brand-driven — highly resistant to digital disruption. No AI/fintech risk. | ✅ Pass |
| **Sustainable Economics (10+ years)** | India's housing and urbanisation trend ensures growing demand. Asian Paints' competitive advantages should persist. | ✅ Pass |
| **Price Below Intrinsic Value** | At 62x PE and 12.4x P/B, the price is 53-264% ABOVE intrinsic value depending on scenario (Optimistic IV ₹1,638 to Stress IV ₹686). The Base case (₹1,198) shows 109% overvaluation. | ❌ Fail — Decisively |

### Buffett's Verdict

Buffett would LOVE the business but HATE the price.

Asian Paints is precisely the type of business Buffett has built his career on — a simple, understandable consumer franchise with a wide moat, excellent management, high returns on capital, zero leverage, and a long runway for growth. It is the Indian equivalent of See's Candies or Coca-Cola in its competitive positioning.
...
If working with a **small capital base**, Buffett would be even more disciplined. Small capital demands concentration in the best risk-reward opportunities. Tying up capital in a stock that's likely to deliver 7-8% returns (below the risk-free rate + equity risk premium) is an opportunity cost disaster when better risk-reward setups exist elsewhere.
...
|---|---|---|---|
| **Birla Opus competitive disruption** — sustained market share loss of 5pp+ over 5 years | High | Medium-High | Brand strength, distribution depth, tinting lock-in. But Birla has the resources to persist. |
| **Raw material cost inflation** — crude/TiO₂ spike crushing margins for 2-3 quarters | Medium | High | Price hikes with 1-2 quarter lag; hedging through scale procurement. Historical track record of recovery. |
| **PE multiple compression** — market re-rates from 60x to 35-40x | Very High (capital loss) | Medium | Only mitigation is not overpaying on entry. |
| **Demand slowdown** — housing/real estate downturn reducing repainting frequency | Medium | Medium | Decorative repainting is semi-discretionary; resilient but not immune. |
| **Home décor drag** — kitchen/bath/White Teak ventures continue destroying value | Low | Medium | Capital allocation risk. FY26 impairment on White Teak is a warning. Management may need to cut losses. |
| **International business geopolitical risk** — Middle East/Africa subsidiaries face currency/political shocks | Low | Low-Medium | International is only ~10% of revenue; limited impact on consolidated numbers. |
| **Management succession** — risk if Amit Syngle (CEO) or key executives depart | Low | Low | Professional management culture; deep bench of talent. |
| **Technological disruption** — digital, AI, or e-commerce disintermediation of the paint category | Negligible | Very Low | Decorative paint is low-tech, tactile, applied by trained painters. No platform-risk exposure. AI colour-visualisation tools structurally benefit brand leaders by accelerating consumer decision-making within Asian Paints' product range. See Section 10 "Technological Disruption Risk" analysis. |
...
The paint industry in India faces relatively benign regulatory risk. The primary regulatory touchpoints are the Bureau of Indian Standards (BIS) for product quality standards, environmental regulations for manufacturing (VOC limits), and GST/customs duty on raw materials.

### Historical Regulatory Impact

| Event | Year | Nature | Impact |
|---|---|---|---|
| GST Implementation | 2017 | Tax reform — unified rate of 18-28% replaced complex state taxes | Short-term disruption; medium-term positive (simplified logistics, eliminated cascading taxes) |
| Demonetisation | 2016 | Cash withdrawal | 1-2 quarter volume dip; full recovery. Paint demand is driven by housing, not speculative cash. |
| COVID Lockdowns | 2020 | Factory/dealer shutdowns | Q1 FY21 was devastated; followed by pent-up demand surge in FY21-FY22. Full recovery. |
...
> **Note:** As of the analysis date (April 2026), this GST rationalisation is speculative — not enacted. The analysis above is contingent on policy action.
...
**Not Applicable.** Asian Paints is NOT a turnaround story — it is a high-quality business experiencing cyclical margin pressure and competitive intensity. The FY25 earnings decline is concerning but does not represent structural impairment requiring a "turnaround." The company remains profitable, cash-generative, and market-leading. This section would only be activated if ROCE fell below 15% for multiple consecutive years or if market share erosion accelerated to 5pp+ — neither has happened.
...
|---|---|---|
| **Business Quality** | 9/10 | One of India's finest consumer franchises. Simple model, predictable demand, high brand loyalty. |
| **Moat Durability** | 7/10 | Wide moat (brand, distribution, tinting) but Birla Opus poses the first serious threat in decades. Watch closely. |
...
| **Margin of Safety** | 1/10 | Negative margin of safety by every DCF measure. Overvalued by 53-171% above intrinsic value in the primary scenario range (CMP ₹2,500 vs IV range of ₹922-₹1,638); 264% above Stress IV of ₹686. |
...
**The business thesis — YES, absolutely:**

"Asian Paints makes the paint that goes on the walls of most houses in India. When people build new houses or repaint old ones, they buy Asian Paints because it's the most famous and trusted brand. The company makes a lot of money because it sells billions of litres of paint every year at a good profit."

A 10-year-old would understand this instantly. This IS a Buffett business.

**The investment thesis at current prices — NO:**

"Asian Paints is a wonderful business, but the stock costs 62 times what the company earns in a year. That means if you bought the whole company, it would take you 62 years to get your money back from the profits. For comparison, most good companies cost 15-25 times their earnings. Asian Paints would need to grow its profits by 10-15% every year for a decade just for you to earn a decent return — and lately, profits have been shrinking, not growing."
...
Asian Paints at ₹2,500 doesn't violate Rule No. 1 in the permanent capital loss sense — this business won't go to zero. But it likely violates Rule No. 1 in the opportunity cost sense — your capital will earn sub-par returns while better opportunities pass you by. The wonderful business deserves a place in your portfolio. It just doesn't deserve to be bought at any price. Wait for the pitch.

---

**Disclaimer:** This analysis is for educational purposes only and does not constitute investment advice. The author is not a registered financial advisor. All investors should conduct their own due diligence and consult with a qualified financial advisor before making investment decisions. Past performance does not guarantee future results.

---
*Analysis completed: April 24, 2026*  
*Data sources: Screener.in (consolidated financials), BSE/NSE (market data), company filings, analyst reports*  
*All calculations verified via Python script with independent computation from raw Screener data*