# PAGE INDUSTRIES LTD (NSE: PAGEIND) — Warren Buffett Analysis
### Exclusive Licensee of Jockey International in India
**Analysis Date:** April 21, 2026 | **CMP:** ₹35,400 | **Market Cap:** ₹39,477 Cr | **Sector:** Consumer Discretionary — Garments & Apparels

---

> *"The key to investing is not assessing how much an industry is going to affect society, or how much it will grow, but rather determining the competitive advantage of any given company and, above all, the durability of that advantage."* — Warren Buffett

**Sector Detection: STANDARD MODE** — Page Industries is a consumer franchise / branded apparel manufacturer, not a financial institution.

---

## 1. THE BUSINESS — Understanding the Economic Engine

Page Industries is the **exclusive licensee** of Jockey International Inc. (USA) for manufacturing, distributing, and marketing the Jockey brand across India, Sri Lanka, Bangladesh, Nepal, UAE, Oman, Qatar, Maldives, Bhutan — and as of FY25, Saudi Arabia, Bahrain, and Kuwait. It also holds the exclusive license for Speedo International (swimwear) in India.

**Would Buffett understand this?** Absolutely. This is perhaps the simplest business model in Indian equities: buy cotton yarn → manufacture innerwear and athleisure → sell under one of the world's most trusted innerwear brands → collect a royalty-enhanced margin. A 10-year-old could understand it.

**What type of business is this?** This is a **consumer franchise** — one of Buffett's favourite business types. Jockey's brand in Indian innerwear commands a 10-15% ASP premium over competitors. The product is a daily essential (recession-resistant demand), the brand has exceptional recall, and the switching cost is psychological — once a consumer trusts their innerwear brand, they don't experiment.

Buffett: *"A brand is a promise."* Jockey's promise is comfort, quality, and consistency. That promise has been kept for 147 countries over decades. Page Industries is simply the Indian delivery mechanism for that promise.

**The Economic Engine:**
- **Revenue model:** Manufacture + distribute branded innerwear/athleisure through 1,13,600+ MBOs, 1,556 EBOs, and 1,778 LFS outlets, plus a growing e-commerce channel.
- **Outsourcing:** 36% of production is outsourced, providing cost flexibility.
- **Installed capacity:** 260 million pieces/year across 15 manufacturing units (2.4 million sq ft).
- **Moat type:** Brand franchise + exclusive license (legal moat) + distribution depth + switching costs.
...
Buffett: *"We enjoy the process far more than the proceeds, though we have learned to live with those also."* Page Industries generates more cash than it can productively deploy, so it returns the excess. This is the hallmark of a capital-light franchise.
...
| Metric | FY14 | FY15 | FY16 | FY17 | FY18 | FY19 | FY20 | FY21 | FY22 | FY23 | FY24 | FY25 |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| CFO (₹ Cr) | 75 | 167 | 219 | 274 | 453 | 230 | 517 | 696 | 327 | **-2** | **1,080** | **1,204** |
...
**Key Observations:**
- FY23's negative CFO was an anomaly driven by massive inventory build-up (inventory days spiked to 279 from 208). This was fully reversed in FY24-25 as inventory normalised.
- FY25's ₹1,204 Cr CFO is the strongest ever — 1.65x net profit, indicating exceptional cash conversion.
- Owner Earnings of ₹707 Cr (FY25) tracks close to net profit because this is a capital-light business. Net Income + D&A - Maintenance CapEx ≈ Net Income for Page.
- **Cumulative FCF (FY14-FY25): ~₹3,954 Cr vs Cumulative Net Profit: ~₹4,679 Cr** — 85% cash conversion ratio. The 15% gap is entirely explained by working capital swings and capacity expansion.

Buffett on Owner Earnings: *"The primary test of managerial economic performance is the achievement of a high earnings rate on equity capital employed (without undue leverage, accounting gimmickry, etc.)."* Page passes this test emphatically.
...
|---|---|---|---|
| ROE > 15% consistently | >15% | 46.0% (10Y avg) | ✅ EXCEPTIONAL |
| ROCE > 15% | >15% | 45-69% range | ✅ EXCEPTIONAL |
| D/E < 0.5 | <0.5 | 0.08-0.30 range | ✅ PASS |
| Consistent profit growth | Growing | 14.0% CAGR 10Y | ✅ PASS |
| Sales growth | Growing | 12.3% CAGR 10Y | ✅ PASS |
...
**Verdict: CRUISING** — steady and predictable, classic Buffett compounding machine. Growth is modest (5-8% YoY) but margins are expanding, and the business generates predictable quarterly earnings in the ₹165-205 Cr range.
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| Promoters | 46.12 | 46.12 | 45.11 | 45.11 | 45.11 | 45.04 | 44.29 | 42.89 | 42.89 | 42.89 | 42.89 | 42.89 | ↓ |
| FIIs | 22.38 | 21.99 | 21.98 | 21.78 | 20.86 | 20.55 | 20.84 | 22.67 | 23.58 | 24.03 | 23.20 | 20.71 | → (volatile) |
| DIIs | 21.26 | 21.41 | 22.92 | 23.92 | 25.85 | 27.35 | 28.76 | 28.69 | 27.87 | 27.75 | 28.52 | 30.78 | ↑↑ STRONG |
| Government | 0.61 | 0.61 | 0.63 | 0.71 | 0.76 | 0.75 | 0.75 | 0.75 | 0.75 | 0.75 | 0.71 | 0.71 | → |
| Public/Retail | 9.61 | 9.88 | 9.35 | 8.49 | 7.43 | 6.30 | 5.35 | 5.02 | 4.92 | 4.59 | 4.67 | 4.90 | ↓↓ |
| # Shareholders | 90,855 | 1,02,337 | 98,082 | 92,192 | 84,513 | 69,796 | 57,515 | 52,181 | 50,905 | 48,076 | 47,103 | 54,428 | ↓ then ↑ |

**Analysis:**
1. **Promoter Decline:** From 46.12% to 42.89% over 3 years (3.23 pp reduction). The Genomal family has been gradually reducing its stake — this is the primary concern. No pledging reported, suggesting this is planned monetisation.
2. **DII Accumulation:** The standout signal — DIIs have surged from 21.3% to 30.8%, absorbing essentially all the promoter selling and then some. ICICI Prudential MF crossed 5% holding in Dec 2025. This is classic "smart money" domestic accumulation during a price decline.
3. **FII Exit:** FIIs reduced from 22.4% to 20.7% — modest decline, with volatility quarter-to-quarter. The April 2026 tariff concerns likely accelerated FII selling.
4. **Retail Exit:** Public holding halved from 9.6% to 4.9% — retail investors have been selling into the price decline. The number of shareholders dropped from 1,02,337 to 47,103 before recovering slightly to 54,428.

**Contrarian Signal:** DII accumulation during promoter sell-down and FII exit at depressed prices is a textbook contrarian bullish setup. Domestic institutional money sees value that foreign money and retail are ignoring.
...
| Metric | FY14 | FY15 | FY16 | FY17 | FY18 | FY19 | FY20 | FY21 | FY22 | FY23 | FY24 | FY25 |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| Total CapEx (est. ₹ Cr) | 50 | 58 | 24 | 68 | 65 | 42 | 188 | 42 | 118 | 246 | 183 | 202 |
| CapEx as % of Revenue | 4.2% | 3.8% | 1.3% | 3.2% | 2.5% | 1.5% | 6.4% | 1.5% | 3.0% | 5.2% | 4.0% | 4.1% |
| Maint. CapEx (est. 60%) | 30 | 34 | 14 | 40 | 39 | 25 | 112 | 25 | 70 | 147 | 109 | 121 |
| D&A | 14 | 18 | 24 | 25 | 28 | 31 | 61 | 63 | 65 | 78 | 91 | 99 |
| **Owner Earnings (₹ Cr)** | 138 | 180 | 242 | 251 | 336 | 400 | 292 | 379 | 532 | 502 | 551 | **707** |
| OE vs NP ratio | 0.90 | 0.92 | 1.04 | 0.94 | 0.97 | 1.02 | 0.85 | 1.11 | 0.99 | 0.88 | 0.97 | 0.97 |

**SBC & Share Dilution Analysis:** Page Industries has **zero material SBC** and **zero share dilution** across the entire 12-year period. Diluted share count has remained unchanged at ~1.115 Cr. This section is therefore not applicable — and this is a HUGE positive. Every rupee of reported earnings is a real economic rupee.

Buffett: *"If options aren't a form of compensation, what are they?"* Page never had to answer this question because it doesn't give away pieces of the business to employees. Clean, honest, owner-friendly capitalism.
...
| Metric | FY14 | FY15 | FY16 | FY17 | FY18 | FY19 | FY20 | FY21 | FY22 | FY23 | FY24 | FY25 |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| ROE % | 53.3 | **58.0** | 50.6 | 44.5 | 45.9 | 48.6 | 43.0 | **40.0** | **54.4** | 46.4 | **38.3** | 48.5 |
| ROA % | 22.4 | 26.0 | 26.2 | 25.3 | 27.0 | **28.5** | 24.0 | **21.2** | **28.2** | 23.8 | **21.2** | 27.4 |
| ROIC % | 37.4 | 43.1 | 43.1 | 40.3 | 43.5 | **45.2** | 42.5 | 39.4 | **54.1** | 43.5 | **36.2** | 46.2 |
| ROCE % | 64 | 62 | 62 | 60 | 64 | **69** | 53 | **48** | **67** | 54 | **45** | 59 |
...
|---|---|---|---|---|
| FY14 | 13.0% | 1.73x | 2.37x | 53.3% |
| FY15 | 12.7% | 2.05x | 2.23x | 58.0% |
| FY16 | 12.9% | 2.03x | 1.93x | 50.6% |
| FY17 | 12.5% | 2.03x | 1.76x | 44.5% |
| FY18 | 13.6% | 1.99x | 1.70x | 45.9% |
| FY19 | 13.8% | 2.06x | 1.70x | 48.6% |
| FY20 | 11.6% | 2.06x | 1.80x | 43.0% |
| FY21 | 12.0% | 1.76x | 1.88x | 40.0% |
| FY22 | 13.8% | 2.04x | 1.93x | 54.4% |
| FY23 | 12.1% | 1.96x | 1.95x | 46.4% |
| FY24 | 12.5% | 1.70x | 1.81x | 38.3% |
| FY25 | 14.8% | 1.85x | 1.77x | 48.5% |

**Quality Assessment:**
Page Industries' ROE is driven by the ideal Buffett combination: **high net margins (pricing power)** and **high asset turnover (capital efficiency)**, with **LOW leverage** (equity multiplier of 1.7-2.0x). This is pure business quality, not financial engineering.

ROCE consistently exceeds ROE (59% vs 49% in FY25) — the pre-tax, pre-interest returns are even higher than the after-tax returns to shareholders. The gap is explained by taxes, not leverage. This is the healthy pattern.

Buffett: *"When a management with a reputation for brilliance tackles a business with a reputation for bad economics, it is the reputation of the business that remains intact."* Page Industries has both brilliant management AND brilliant economics.

---

## 10. COMPETITIVE POSITION & MOAT ANALYSIS

**Moat Type: BRAND FRANCHISE + LEGAL EXCLUSIVE LICENSE + DISTRIBUTION DEPTH**

Page Industries possesses a rare multi-layered moat:

1. **Exclusive License Moat (Legal):** The Jockey license for India is exclusive and has been repeatedly renewed/expanded (most recently adding Saudi Arabia, Bahrain, Kuwait in FY25). No competitor can sell Jockey in India — this is a legal monopoly on one of the world's most trusted innerwear brands.

2. **Brand Moat:** Jockey commands 10-15% ASP premium over competitors. In innerwear, brand trust matters enormously — consumers are reluctant to experiment with their most personal garments. This creates psychological switching costs.

3. **Distribution Moat:** 1,13,600+ MBOs, 1,556 EBOs, and 1,778 LFS stores — this distribution network took 25+ years to build. Competitors would need billions of rupees and a decade to replicate it.

4. **Cost/Scale Advantage:** 260 million pieces/year production capacity with 36% outsourcing provides cost flexibility. Scale advantages in cotton procurement and manufacturing.

**Key Competitors and Threats:**
- **Lux Industries / Dollar Industries:** Compete in the value segment (₹50-150 price point). Not a direct threat to Jockey's premium positioning (₹200-800+ price point). Manageable threat.
- **Van Heusen Innerwear (Aditya Birla):** Competes in the premium segment. Limited market share gain against Jockey's first-mover advantage. Manageable threat.
- **D2C brands (Taatva, XYXX, etc.):** Digital-first brands targeting millennials/Gen-Z. Growing fast but from a tiny base. Worth monitoring but not existential. The shift of JKYO Groove to 150+ EBOs shows Page is responding.
- **Unorganised sector:** Still 60-70% of the Indian innerwear market is unorganised. This is not a threat — it is the TAM. Every percentage point of shift from unorganised to organised benefits Jockey.

**Susceptibility to Change:** This is the critical Buffett filter. Innerwear is about as change-resistant as businesses get. People will still wear innerwear in 10, 20, 50 years. The basic product form hasn't fundamentally changed in decades. Fashion trends affect outerwear far more than innerwear. Buffett would love this — *"We do not get enthused about change... we're looking for the absence of change."*

**Verdict: WIDE AND DURABLE MOAT.** The combination of exclusive license, brand trust, distribution depth, and an absence-of-change product category creates a moat that is virtually unassailable in the medium term. The only existential risk is non-renewal of the Jockey license — which would be irrational for Jockey International given Page's track record.
...
The Indian innerwear market is estimated at ₹45,000-50,000 Cr (growing 8-10% annually). Page Industries' ₹5,000 Cr revenue represents approximately 10-11% market share. With 60-70% of the market still unorganised, the shift to branded products provides a massive structural tailwind. The realistic addressable TAM (organised + converting unorganised) gives a **4-5x runway** from current levels.

**S-Curve Position: GROWTH PHASE** — The business model is fully proven, distribution is established, and the company is replicating its formula across Tier 2/3 cities. It's past the inflection point but well before saturation.
...
| **Overall** | **7.6/10** | **Strong Scaler — GEICO / American Express category** |
...
**Buffett's $1 Test:**
- Total Retained Earnings (FY14-FY25): ₹1,232 Cr
- Market Cap Change (FY14 to present): ~₹32,440 Cr (₹7,037 Cr → ₹39,477 Cr)
- **$1 Test Result: ₹26.3x** — For every ₹1 retained by management, ₹26.3 of market value was created.

This is one of the highest $1 test scores in Indian equity history. Buffett: *"The best business to own is one that over an extended period can employ large amounts of incremental capital at very high rates of return."* Page has done this spectacularly — with minimal capital retention (high payout) yet massive value creation.

**Capital Allocation:** Management has demonstrated exceptional discipline — high dividend payouts (86% avg), minimal debt, zero equity dilution, zero M&A destruction. FY25's 138% payout (paying from reserves) signals a belief that the business doesn't need more capital.

**Management Integrity:** The Genomal family has led the company since inception. VS Ganesh (MD) has guided the business through multiple cycles. Management communications are transparent, with specific volume/margin guidance on concalls.

**Concerns:** Declining promoter holding (from 49% in FY17 to 42.9% in Dec25) is the only management-related flag. No fraud, no governance issues, no regulatory penalties.

---

## 13. OPERATING METRICS — Industry-Specific KPIs

| Metric | FY19 | FY20 | FY21 | FY22 | FY23 | FY24 | FY25 | Trend |
|---|---|---|---|---|---|---|---|---|
| EBOs (stores) | ~750 | ~930 | ~930 | ~1,100 | ~1,250 | ~1,400 | ~1,556 | ↑ |
| MBOs (outlets) | ~60,000 | ~60,000 | ~60,000 | ~66,000 | ~80,000 | ~100,000 | ~1,13,600 | ↑↑ |
| LFS stores | — | — | — | — | — | — | ~1,778 | — |
| Outsourcing % | ~30% | ~32% | ~32% | ~34% | ~35% | ~36% | ~36% | → |
| Inventory Days | 229 | 200 | 160 | 208 | **279** | 205 | **147** | ↓ (improving) |
| Working Capital Days | 55 | 42 | 10 | 33 | **59** | 49 | **19** | ↓↓ (excellent) |

**Key Insight:** Working capital days collapsing from 59 (FY23) to 19 (FY25) is a dramatic improvement in capital efficiency. MBO expansion from 60,000 to 1,13,600 outlets in 6 years represents near-doubling of distribution reach — the foundation for the next growth phase.
...
The stock is currently near its 52-week low (₹29,805-₹50,590 range), having declined ~30% from highs due to (a) growth deceleration, (b) promoter selling, (c) US tariff-driven FII outflows, and (d) general market de-rating of high-PE midcaps.
...
This means the market is pricing in growth assumptions that are MORE aggressive than our optimistic case. At 52.7x TTM PE, the market is implicitly expecting 15-20%+ earnings growth sustained for well over a decade — which is possible given the business quality, but leaves no margin of safety.

Buffett: *"Price is what you pay, value is what you get."* At ₹35,400, you are paying a very high price for genuinely excellent value. The question is whether the price is too high for the value.

**Margin of Safety: NEGATIVE across all scenarios.** The stock is currently overvalued relative to a 10% discount rate DCF framework.
...
|---|---|---|---|
| 5 Years | 41.4% | 47.9% | 54.3% |
| 10 Years | 24.7% | 30.4% | 36.1% |
| 15 Years | 19.6% | 25.1% | 30.5% |

**At Terminal PE = 20x (Market Average):**

| Period | 10% Return | 15% Return | 20% Return |
|---|---|---|---|
| 5 Years | 33.5% | 39.6% | 45.7% |
| 10 Years | 21.2% | 26.7% | 32.2% |
| 15 Years | 17.3% | 22.7% | 28.0% |

**At Terminal PE = 28x (Above-Avg Compounder):**

| Period | 10% Return | 15% Return | 20% Return |
|---|---|---|---|
| 5 Years | 24.8% | 30.5% | 36.2% |
| 10 Years | 17.2% | 22.5% | 27.8% |
| 15 Years | 14.7% | 20.0% | 25.2% |

**At Terminal PE = 50x (Historical Avg for Page):**

| Period | 10% Return | 15% Return | 20% Return |
|---|---|---|---|
| 5 Years | 11.2% | 16.2% | 21.3% |
...
|---|---|---|---|
| Trough PE × Trough EPS | 35x × ₹305 (FY21 EPS) | ₹10,687 | -70% |
| Conservative DCF | Section 15 | ₹13,422 | -62% |
| Historical Low PE × current EPS | 45x × ₹672 | ₹30,240 | -15% |
...
**Inputs:** BVPS = ₹1,262 | CMP = ₹35,400 | P/B = 28.1x | ROE = 45% | Retention = 33.6% | BV Compounding = 15.1%
...
#### Expected Return CAGR at Current CMP ₹35,400 (Entry P/B: 28.1x)

| Exit P/B | Rationale | 5Y CAGR | 7Y CAGR | 10Y CAGR |
|---|---|---|---|---|
| 28.1x (sustains) | Multiple holds | 15.1% | 15.1% | 15.1% |
...
|---|---|---|---|---|
| **Deep Value / Strong Buy** | <15x | <30x | <₹18,930 | Extreme fear / black swan. Back up the truck. |
| **Value / Buy** | 15-20x | 30-40x | ₹18,930 - ₹25,240 | Below fair value; attractive risk-reward |
| **Fair Value / Hold** | 20-28x | 40-55x | ₹25,240 - ₹35,336 | Fairly priced; hold for BV compounding |
| **Fully Valued / Trim** | 28-35x | 55-70x | ₹35,336 - ₹44,170 | Premium pricing; limited upside |
| **Overvalued / Sell** | >35x | >70x | >₹44,170 | Priced for perfection; sell/avoid |

**Current Price (₹35,400): BORDERLINE FAIR VALUE / FULLY VALUED** — sitting right at the boundary of the Fair Value and Fully Valued zones.

### Position Assessment for Existing Holders

| Entry Price Zone | Current P&L | Recommendation | Buffett Logic |
|---|---|---|---|
| Deep Value (<₹18,930) | +87% to +∞ | **HOLD** — enormous MoS at entry; let compounding work | *"Our favourite holding period is forever."* |
| Value (₹18,930-₹25,240) | +40% to +87% | **HOLD** — still compounding attractively | Continue holding; trim only if position becomes outsized |
| Fair Value (₹25,240-₹35,336) | 0% to +40% | **HOLD** — but don't add more at current prices | Fair value entry; returns will match business performance |
| Fully Valued (₹35,336-₹44,170) | -20% to 0% | **HOLD reluctantly** — wait for growth to justify price | Don't sell a wonderful business in a temporary dip, but don't add either |
| Overvalued (>₹44,170) | Underwater | **HOLD for tax management** — use LTCG harvesting | Don't add; consider trimming on bounces above ₹45,000 |

---

## 19. WOULD BUFFETT BUY THIS STOCK (Small Capital Base)?

| Checklist Item | Assessment | Verdict |
|---|---|---|
| Circle of Competence | Innerwear = simple, understandable business | ✅ |
| Enduring Moat | Exclusive license + brand + distribution | ✅ |
| Management Trustworthy | 25+ year track record; $1 test = 26.3x | ✅ |
| Resistant to Disruption | Innerwear is change-resistant; no tech disruption risk | ✅ |
| Sustainable Economics for 10+ years | 45%+ ROE for 12 consecutive years | ✅ |
| Price Below Intrinsic Value | DCF IV ₹13,422-21,267 vs CMP ₹35,400 | ❌ OVERPRICED |

**Verdict:** Buffett would **admire this business enormously** — it checks every quality box in his framework. The ROE, the capital-light model, the zero dilution, the brand franchise, the simplicity, the predictability. This is a See's Candies equivalent in India.

**However, Buffett would NOT buy at ₹35,400.** The valuation leaves no margin of safety. At 28x book and 53x earnings, you are paying for perfection and then some. Even with a small capital base where Buffett could earn higher returns from smaller opportunities, he would recognise that 53x PE for a 12% revenue grower provides asymmetry that is marginal at best.

Buffett: *"It's far better to buy a wonderful company at a fair price than a fair company at a wonderful price."* Page Industries is the wonderful company — but ₹35,400 is not a fair price for a 10% hurdle rate investor. It's a fair price only if you're willing to accept 12-15% returns AND the PE sustains at 20x+ for a decade.

**The Buy Price for Buffett:** At 20x P/B (₹25,240) or 35-40x PE (₹23,500-26,860), Buffett would get interested. At 15x P/B (₹18,930) or 30x PE (₹20,150), he would be aggressive. The stock would need to fall another 25-45% from current levels to enter genuine Buffett territory.
...
|---|---|---|---|---|
| Jockey license non-renewal | Catastrophic | Very Low | Terminal | 25+ year relationship; expanded to new markets in FY25 |
| Promoter stake decline below 40% | Medium | Medium | Governance concern | Gradual reduction; no fire sale; DIIs absorbing |
| Cotton price spike | Medium | Medium | Margin compression | Can pass through via ASP hikes with 6-month lag |
| Consumer slowdown | Medium | High | Revenue growth <5% | Essential product; relatively recession-resistant |
| Competition from D2C brands | Low-Med | Medium | Market share nibble | JKYO Groove response; expanding digital presence |
| US tariff-driven macro weakness | Medium | Medium | FII outflows, demand drag | Domestic consumption focus; minimal export exposure |
| Management succession risk | Medium | Low | Execution disruption | Genomal family has depth; VS Ganesh provides continuity |
| PE de-rating to market averages | High | Medium | 30-50% price decline | Fundamental quality limits permanent de-rating |
...
**Not applicable.** Page Industries is not a distressed or turnaround situation. It is a high-quality business experiencing a temporary valuation de-rating after a period of growth deceleration. The underlying economics are excellent and improving (FY25 margins at 12-year highs).
...
|---|---|---|
| Business Quality | **10/10** | Simplest, most predictable business model in Indian consumer space |
| Moat Durability | **9/10** | Exclusive license + brand + distribution; only risk is license non-renewal |
...
| **Buy Zone** | | Borderline **Fair Value / Fully Valued**. First buy zone: ₹25,000 (20x P/B). Aggressive buy: ₹19,000 (15x P/B). |
| **Overall Recommendation** | | **HOLD if owned. WAIT if not.** Add below ₹25,000 with conviction. |
...
*"Page Industries makes Jockey underwear. Everyone needs underwear. People buy the same brand again and again because they trust it. Page is the ONLY company allowed to make Jockey in India. They make ₹2 Cr profit every day. They have almost no debt. They give most of the money back to shareholders as dividends."*

Yes. A 10-year-old would understand this business.

**Does the math work on a napkin?**

- Page earns ₹654 per share.
- Stock trades at ₹35,400 — that's 54x earnings.
- If earnings grow 14% (historical rate) for 10 years: EPS → ₹2,430.
- At 30x PE (reasonable for a mature, high-quality business): Price → ₹72,900.
- From ₹35,400 → ₹72,900 = 7.5% CAGR + ~2.5% dividend yield = ~10% total return.

Barely makes the hurdle rate on a napkin. You need either faster growth or sustained premium PE for the math to be compelling. For Buffett, a napkin calculation that "barely works" at 10% is not a fat pitch — he'd wait for a price where the napkin math screams 15-20%.

Buffett: *"If you need a spreadsheet to figure out whether it's a good deal, it's not a good deal."* At ₹35,400, you need a spreadsheet. At ₹25,000, the napkin math works easily. At ₹20,000, it's a no-brainer.

---

> *"The stock market is a device for transferring money from the impatient to the patient."* — Warren Buffett

Page Industries rewards the patient investor. The business quality ensures that the underlying value compounds at 15%+ annually through book value growth. The challenge is the entry price. Patient investors who wait for market fear to bring this stock to 20-25x P/B will be rewarded handsomely. Those who buy at 28x P/B will earn good (not great) returns, assuming the quality persists. Those who buy above 35x P/B are paying for hope, not value.

**Final Word:** Page Industries is proof that moats exist in India. It is a business Buffett would hold forever — once he bought it at the right price. Today is not that day. But when the market inevitably panics again — as it always does — this should be at the very top of your buy list.

---

*Disclaimer: This analysis is for educational purposes only and does not constitute investment advice. All data sourced from Screener.in and public filings. Calculations verified via Python. The author may or may not hold positions in the securities discussed.*