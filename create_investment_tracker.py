...
companies = [
    ("Adcounty Media India", "544435", "BSE", "7/10", 100, 150, 250, 308, 193, 308, 400, False, "Asset-light AdTech; 30%+ revenue CAGR. RISK: debtor days 69-161, weak moat"),
    ("Advani Hotels & Resorts", "ADVANIHOTR", "NSE", "5/10", 26, 37, 45, 50, 30, 37, 50, False, "Single 5-star Goa asset; 34% ROE but zero growth runway"),
    ("Ambuja Cements", "AMBUJACEM", "NSE", "6/10", 270, 380, 500, 588, 268, 588, 700, False, "3rd largest cement; 100+ MTPA. Commodity business, Adani-backed"),
    ("APL Apollo Tubes", "APLAPOLLO", "NSE", "7.5/10", 820, 1200, 1500, 1800, 1000, 1500, 2000, False, "50% market share steel tubes; 22%+ ROCE. Fortress balance sheet"),
    ("Apollo Tyres", "APOLLOTYRE", "NSE", "3.5/10", 200, 270, 356, 420, 229, 356, 519, False, "Mediocre ROE 9-10%; commodity business; deteriorating cash conversion"),
    ("Arrow Greentech", "ARROWGREEN", "NSE", "6.8/10", 400, 600, 839, 1200, 839, 1563, 2000, False, "India's largest water-soluble film maker; 50%+ ROIC, zero debt. Volatile earnings"),
    ("AU Small Finance Bank", "AUBANK", "NSE", "4.5/6", 400, 610, 750, 900, 485, 610, 800, False, "Superior NIM 5.5-6%; first SFB to get universal bank license. Overpriced"),
    ("Avenue Supermarts (DMart)", "DMART", "NSE", "8/10", 1316, 1974, 2500, 3000, 1316, 2015, 2500, False, "Lowest-cost retailer; 13.4% ROE, debt-free. Founder 74.65% ownership"),
    ("Axis Bank", "AXISBANK", "NSE", "6/6", 900, 1105, 1430, 1700, 1100, 1430, 3537, False, "True Buffett Bank; 16% ROE, #1 merchant acquiring (19.7% share)"),
    ("Bandhan Bank", "BANDHANBNK", "NSE", "3/6", 103, 150, 183, 230, 103, 183, 289, False, "Contrarian only; near book value. Weak moat, management transition"),
    ("Bank of Baroda", "BANKBARODA", "NSE", "4/6", 180, 230, 307, 370, 230, 307, 400, False, "GNPA improved 9.4% to 2.04%; 15.6% ROE at 0.91x P/B. PSU governance risk"),
    ("Bank of India", "BANKINDIA", "NSE", "3/6", 120, 150, 185, 220, 150, 185, 230, False, "Fair company at fair price; ROA <1%, NIM compressing. PSB constraints"),
    ("Bharat Electronics", "BEL", "NSE", "9.5/10", 200, 280, 374, 450, 223, 374, 530, False, "Govt monopoly defence electronics; 39% ROCE, debt-free. Rs73,450 Cr order book"),
    ("Bharti Airtel", "BHARTIARTL", "NSE", "7.6/10", 1200, 1500, 1800, 2200, 1400, 3572, 4500, False, "Telecom oligopoly toll-bridge; 57% operating margins, 65% profit CAGR"),
    ("Groww (Billionbrains)", "GROWW", "NSE", "6.5/10", 95, 119, 187, 259, 119, 259, 350, False, "62% EBITDA margins, 50% ROE. RISK: 53% revenue from derivatives (SEBI crackdown)"),
    ("Canara Bank", "CANBK", "NSE", "7.5/10", 90, 120, 160, 200, 120, 160, 220, False, "Best-in-class PSB asset quality; GNPA 2.08%, 18% ROE. Weak CASA 29.5%"),
    ("Caplin Point Laboratories", "CAPLIPOINT", "NSE", "8.3/10", 1200, 1565, 1947, 2500, 1947, 2700, 3452, False, "Elite pharma compounder; 23% ROE, 26% ROCE, zero debt, Rs600 Cr net cash"),
    ("Castrol India", "CASTROLIND", "NSE", "7/10", 120, 150, 190, 216, 150, 216, 250, False, "60% ROCE, 5% div yield, zero debt cash cow. EV transition risk long-term"),
    ("CEAT Ltd", "CEATLTD", "NSE", "4.7/10", 1000, 1350, 2000, 2315, 1349, 2315, 2800, False, "Mediocre tyre business; commodity-dependent, capital-intensive"),
    ("Coal India", "COALINDIA", "NSE", "8.5/10", 300, 400, 491, 600, 491, 693, 850, False, "World's largest coal producer; 38% ROE, 5.8% div yield. Energy transition risk post-2035"),
    ("Colgate-Palmolive India", "COLPAL", "NSE", "5/6", 1100, 1370, 1615, 1960, 1302, 1615, 1960, False, "80%+ ROE, 89-yr franchise, zero debt. Market share eroding 58% to 43%"),
    ...
    ("Cupid Ltd", "CUPID", "NSE", "1/10", 0, 0, 0, 0, 15, 25, 30, True, "WEAK BUSINESS: 123x PE, negative OCF, tender-dependent. Fails all Buffett criteria"),
    ("Dabur India", "DABUR", "NSE", "2/10", 200, 280, 346, 420, 199, 280, 346, False, "140-yr heritage but stagnating; 45x PE for 4% growth. Declining ROE"),
    ("Data Patterns India", "DATAPATTNS", "NSE", "8/10", 1000, 1500, 2200, 3000, 1200, 1500, 2200, False, "Leading defence electronics; 30-35% revenue CAGR. RISK: negative OCF, 618-day CCC"),
    ("Energy Infrastructure Trust", "542543", "BSE", "8.3/10", 70, 90, 110, 130, 99, 130, 160, False, "AAA-rated monopoly gas pipeline; 18.7% distribution yield. Illiquidity risk"),
    ("EPack Prefab", "EPACKPEB", "NSE", "7.8/10", 120, 178, 252, 400, 252, 560, 800, False, "3rd largest PEB maker; 36% rev CAGR, net cash, PEG 0.48. Narrow moat risk"),
    ("Evans Electric", "542668", "BSE", "8.8/10", 40, 60, 100, 165, 80, 130, 211, False, "75-yr niche specialist; 30% ROE, 41% ROCE, zero debt, 5.7x PE. Extreme illiquidity"),
    ("Federal Bank", "FEDERALBNK", "NSE", "5/6", 147, 206, 265, 310, 206, 265, 330, False, "Clean bank, NRI remittance moat. CASA 32% weak; stretched at 1.86x P/B"),
    ("Force Motors", "FORCEMOT", "NSE", "6.9/10", 10500, 14000, 18096, 22000, 10523, 18096, 29287, False, "Traveller near-monopoly; Mercedes/BMW component supply. ROE surged -6.5% to 30.3%"),
    ...
    ("Gillette India", "GILLETTE", "NSE", "9.5/10", 4500, 5864, 7000, 8000, 5864, 7000, 8500, False, "Razor-and-blade moat; 59% ROCE, 42% ROE. Electric trimmer disruption risk"),
    ("HDFC Bank", "HDFCBANK", "NSE", "5.5/6", 550, 728, 910, 1050, 728, 910, 1200, False, "India's best bank franchise; GNPA 1.24%, 9,600+ branches. Post-merger integration"),
    ("Hindustan Unilever", "HINDUNILVR", "NSE", "9/10", 1150, 1470, 1800, 2100, 1470, 1800, 2200, False, "India's FMCG crown jewel; 50+ brands, 9M outlets, 20.7% ROE. D2C disruption"),
    ("Hyundai Motor India", "HYUNDAI", "NSE", "6/10", 1100, 1400, 1902, 2200, 1290, 1902, 2500, False, "India's #2 PV maker; debt-free, 54% ROCE. Parent cash extraction risk"),
    ("ICICI Bank", "ICICIBANK", "NSE", "5.5/6", 900, 1114, 1500, 1936, 1114, 1500, 2234, False, "Elite franchise; 18% ROE, highest ROA (2.18%) among large banks. Turnaround complete"),
    ("IndiaMART", "INDIAMART", "NSE", "7.5/10", 1500, 2000, 2440, 3010, 2440, 3010, 3500, False, "B2B toll-bridge; 60% market share, 44% FCF margins, Rs3,051 Cr cash. Founder 49% stake"),
    ("Indian Bank", "INDIANB", "NSE", "4/6", 500, 770, 900, 1100, 770, 900, 1500, False, "PSB turnaround; ROE 17%, GNPA 2.2%, 33% cost-to-income. PSU governance risk"),
    ("Indus Towers", "INDUSTOWER", "NSE", "7.6/10", 240, 360, 480, 611, 360, 611, 800, False, "India's largest tower co; 29% ROCE, 33% ROE, AAA-rated. Declining tenancy ratio"),
    ("Info Edge (Naukri)", "NAUKRI", "NSE", "8.4/10", 700, 900, 1043, 1193, 943, 1043, 1193, False, "80% recruitment traffic share; debt-free, Rs4,000 Cr cash. AI disruption wildcard"),
    ("Infosys", "INFY", "NSE", "4/7", 1026, 1256, 1500, 1729, 1026, 1729, 2000, False, "Record cash flows; strong client relationships. AI threatens labour-arbitrage moat"),
    ("International Conveyors", "INTLCONV", "NSE", "5.5/10", 40, 55, 72, 92, 55, 88, 120, False, "Niche PVC conveyor belt maker; 85% coal-dependent. Investment portfolio = 64% of mcap"),
    ("IRCTC", "IRCTC", "NSE", "7/10", 300, 400, 450, 565, 356, 445, 600, False, "Govt monopoly railway ticketing; 35%+ ROE, near-zero debt. Policy risk on convenience fee"),
    ("ITC", "ITC", "NSE", "7.5/10", 220, 270, 320, 386, 270, 386, 450, False, "80% cigarette market share; 27% ROE, 4.5% div yield. Tax hike + ESG FII exodus risk"),
    ("JK Paper", "JKPAPER", "NSE", "6/10", 226, 291, 388, 517, 307, 430, 556, False, "Integrated paper maker; low-cost producer. Commodity cyclical business"),
    ("Kalyan Jewellers", "KALYANKJIL", "NSE", "5/10", 210, 330, 440, 600, 210, 380, 600, False, "Strong brand, franchise model expanding. Jewellery is low-moat commodity retail"),
    ("Kamdhenu", "KAMDHENU", "NSE", "8/10", 16.8, 25.8, 38.7, 51.6, 24.1, 31.7, 41.3, False, "Asset-light franchise model; high ROCE, brand royalty revenue stream"),
    ("Karur Vysya Bank", "KARURVYSYA", "NSE", "5.5/10", 158, 224, 304, 396, 198, 293, 387, False, "Improving asset quality; regional moat in Tamil Nadu. Limited growth runway"),
    ("Kotak Mahindra Bank", "KOTAKBANK", "NSE", "8/10", 200, 316, 375, 475, 316, 375, 500, False, "Premium bank franchise; strong management, conservative underwriting"),
    ("KPIT Technologies", "KPITTECH", "NSE", "7/10", 420, 620, 840, 1000, 500, 820, 1200, False, "EV/automotive tech niche; sticky Tier-1 clients, secular tailwind"),
    ("KSE Ltd", "KSE", "NSE", "5.5/10", 132, 198, 275, 385, 224, 300, 366, False, "Dominant Kerala dairy; asset-light operations, steady cash flows"),
    ("Mahalaxmi Rubtech", "MAHALAXMI", "NSE", "8.2/10", 112, 186, 298, 330, 251, 440, 600, False, "Niche rubber products; high margins, strong ROCE, undiscovered micro-cap"),
    ("Maharashtra Seamless", "MAHSEAMLESS", "NSE", "9/10", 392, 539, 735, 980, 895, 1335, 2043, False, "Passes all 10 Buffett criteria; debt-free, seamless pipe leader"),
    ("Mahindra & Mahindra", "M&M", "NSE", "7/10", 1750, 2250, 3125, 4000, 2988, 3951, 5159, False, "SUV dominance; diversified conglomerate, farm+auto dual engines"),
    ("Maruti Suzuki", "MARUTI", "NSE", "9/10", 8300, 11000, 11490, 12757, 8532, 11490, 17793, False, "India's dominant auto (41% share); debt-free, 62% ROIC, Rs66K Cr cash"),
    ("MRF Ltd", "MRF", "NSE", "6/10", 82500, 100850, 128350, 160440, 90600, 130400, 201200, False, "India's largest tyre maker; fortress balance sheet. Mediocre 10.5% ROE"),
    ("Nestle India", "NESTLEIND", "NSE", "10/10", 688, 946, 1204, 1462, 408, 602, 792, False, "MAGGI/NESCAFE/KIT KAT franchise; 96% ROCE, 27% ROA. 69x PE = no MoS"),
    ("Olectra Greentech", "OLECTRA", "NSE", "5/10", 275, 480, 685, 960, 526, 972, 1599, False, "India's largest EV bus maker. Eroding moat, negative FCF, BYD-dependent"),
    ("PC Jeweller", "PCJEWELLER", "NSE", "3/10", 5, 7, 10, 15, 3.7, 10, 19.3, False, "Turnaround cigar butt; massive debt reduction. 4.5x equity dilution, broken economics"),
    ("Procter & Gamble Hygiene", "PGHH", "NSE", "8/10", 6375, 8160, 10710, 14025, 5651, 8315, 11576, False, "Whisper 55% share + Vicks; 104% ROCE, zero debt. Overpriced at 42x PE"),
    ("PTC India", "PTC", "NSE", "4/10", 89, 118, 167, 207, 107, 157, 251, True, "WEAK: Eroding intermediary moat; zero revenue growth for decade. 7.38% div yield"),
    ("Reliance Industries", "RELIANCE", "NSE", "6/10", 600, 800, 1050, 1350, 1074, 1533, 2368, False, "Jio oligopoly is Buffett-like; conglomerate dilutes quality. 8% ROE at 2.17x P/B"),
    ("Sacheerome Ltd", "SACHEEROME", "NSE", "9/10", 161, 236, 321, 429, 261, 373, 545, False, "B2B fragrance niche; 39% ROCE, debt-free, 52% EPS CAGR, switching costs"),
    ("Shilchar Technologies", "SHILCTECH", "NSE", "9/10", 2400, 3200, 4500, 5600, 4050, 4930, 10000, False, "Transformer maker; 71% ROCE, zero debt, 37% book value CAGR, export growth"),
    ...
    ("Shriram Finance", "SHRIRAMFIN", "NSE", "9/10", 615, 850, 1025, 1230, 410, 660, 1210, False, "Wide moat NBFC; 2.8% ROA, used CV finance leader, 3,225+ branches"),
    ("Solar Industries", "SOLARINDS", "NSE", "10/10", 5600, 8000, 10400, 13600, 5450, 8300, 11620, False, "India's explosives monopoly; 31% ROCE, 73% promoter, defence order visibility"),
    ("South Indian Bank", "SOUTHBANK", "NSE", "6/10", 27, 38, 50, 67, 27, 38, 50, False, "Cyclical recovery; GNPA 5.48% to 2.67%, ROA surged to 1.08%, 0.90x P/B"),
    ("SPML Infra", "SPMLINFRA", "NSE", "3/10", 74, 105, 158, 210, 107, 222, 418, True, "WEAK: Commodity EPC, no moat, erratic cash flows, negative 10Y avg EPS"),
    ...
    ("SAIL", "SAIL", "NSE", "2/10", 114, 143, 186, 243, 91, 146, 204, True, "WEAK: Commodity steel, 4-5% ROE destroys value. Zero growth, no moat"),
    ("Swaraj Engines", "SWARAJENG", "NSE", "9/10", 2000, 2700, 3600, 4500, 3377, 5014, 6335, False, "Captive Mahindra supplier; 42% ROE, 56% ROCE, zero debt, 80% payout"),
    ("Systango Technologies", "SYSTANGO", "NSE", "4/10", 200, 275, 400, 550, 519, 1043, 1703, False, "Micro-cap IT; 36% margins, zero debt, 54% profit CAGR. Client concentration risk"),
    ("Tanfac Industries", "TANFACIND", "NSE", "9/10", 1705, 2728, 4092, 5456, 1887, 3322, 6228, False, "India's largest fluorine chemicals; 45% ROCE, regulatory moat, near-zero debt"),
    ("Tata Motors", "TMPV", "NSE", "4/10", 240, 400, 600, 900, 571, 834, 1168, False, "Deep value at 1.15x book; 87% EV dominance, India CV #1. JLR cyclically stressed"),
    ("Tata Power", "TATAPOWER", "NSE", "6/10", 168, 247, 336, 426, 90, 182, 371, False, "Regulated monopoly T&D (62% rev); strong Tata backing. Overpriced at 34x PE"),
    ("Tata Steel", "TATASTEEL", "NSE", "5/10", 61, 91, 122, 186, 4, 60, 224, False, "India cost moat via captive iron ore. At historic peak P/B; commodity cyclical"),
    ("Titan Company", "TITAN", "NSE", "9/10", 1850, 2550, 3500, 4650, 2181, 3946, 6525, False, "Trust-based jewellery moat; 9/10 quality, 30%+ ROE. 89x PE = no MoS"),
    ("TVS Holdings", "TVSHLTD", "NSE", "9/10", 7700, 11550, 15400, 19250, 18650, 23700, 33250, False, "67% holdco discount; owns 50% TVS Motor + NBFC. 31%+ upside conservative"),
    ("TVS Motor", "TVSMOTOR", "NSE", "9/10", 1500, 2100, 2800, 3500, 1487, 3007, 5369, False, "India's 3rd largest 2W; 30% ROE, EV leader (iQube). 57x PE = fully valued"),
    ("Varun Beverages", "VBL", "NSE", "9/10", 225, 288, 377, 494, 248, 402, 562, False, "Largest PepsiCo bottler globally; 20% ROCE, consumer franchise. 45.8x PE"),
    ("Alphabet (Google)", "GOOGL", "NASDAQ", "9/10", 220, 280, 360, 430, 222, 279, 354, False, "Search monopoly + AI moat; 35.7% ROE, $164.7B OCF. Fairly valued at $340"),
    ("Amazon", "AMZN", "NASDAQ", "10/10", 200, 250, 320, 400, 211, 254, 307, False, "Multi-moat giant; AWS 31% cloud share, 22.3% ROE. At value zone ($250)"),
    ("Apple", "AAPL", "NASDAQ", "10/10", 148, 185, 222, 259, 94, 123, 166, False, "10/10 quality; $100B+ FCF, 31% ROA, ecosystem moat. Fully valued at 34x PE"),
    ("Broadcom", "AVGO", "NASDAQ", "9.3/10", 250, 325, 425, 550, 125, 182, 265, False, "AI data center toll bridge; 42% FCF margin, 68% gross margins, elite mgmt"),
    ("Meta Platforms", "META", "NASDAQ", "7.6/10", 445, 594, 743, 950, 634, 926, 1276, False, "3.58B DAU ad monopoly; 82% gross margins, $46.1B FCF. AI capex risk"),
    ("Microsoft", "MSFT", "NASDAQ", "10/10", 320, 400, 480, 608, 357, 451, 573, False, "Enterprise toll bridge; 30%+ ROE, $51B net cash, AI/Azure widening moat"),
    ("NVIDIA", "NVDA", "NASDAQ", "10/10", 130, 170, 220, 280, 132, 193, 274, False, "AI GPU monopoly; 55% net margins, 101% ROE, $55B net cash. Fair value at $200"),
    ("PayPal", "PYPL", "NASDAQ", "7/10", 54, 81, 119, 162, 104, 131, 165, False, "Deep value at 9.4x PE; 25.8% ROIC, $5.6B FCF. Narrowing moat, mgmt instability"),
]
